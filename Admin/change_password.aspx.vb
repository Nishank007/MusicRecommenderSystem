...
Partial Class change_password
    ...
    Protected Sub btnreg_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnreg.Click
        ...
        da.SelectCommand.CommandText = "select * from admin where user_id = " & user_id & ""
        ...
        Else
            ...
            da.SelectCommand = New SqlCommand
            da.SelectCommand.Connection = conn
            da.SelectCommand.CommandText = "update admin set password = '" & txtnpass.Text & "' where user_id = " & user_id & ""
            da.SelectCommand.CommandType = Data.CommandType.Text
            ds = New Data.DataSet
